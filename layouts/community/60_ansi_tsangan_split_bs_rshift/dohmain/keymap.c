...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    [COLEMAK] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSLS, KC_GRV,
    ...
    [FUNCTION] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    [ADJUST] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
