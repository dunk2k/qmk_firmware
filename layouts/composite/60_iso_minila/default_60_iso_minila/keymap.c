...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───┴──┬┴───┼───┴┬──┴─┬─┴───┴───┴─┬─┴──┬┴───┼───┼───┼───┼───┤
     * │Ctrl  │GUI │Alt │mo1 │           │ mo1│AltG│App│ ← │ ↓ │ → │
     * └──────┴────┴────┴────┴───────────┴────┴────┴───┴───┴───┴───┘
     */    
    [0] = LAYOUT_60_iso_minila(
     ...
     * └──────┴────┴────┴────┴───────────┴────┴────┴───┴───┴───┴───┘
     */ 
    [1] = LAYOUT_60_iso_minila(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, QK_BOOT,
        _______, _______, _______, KC_UP,   _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, _______,
